...
test("renders the surveyor-facing property workflow without demo content", () => {
  ...
  assert.match(html, /On-site survey/);
  assert.match(html, /Jamie Taylor/);
  assert.match(html, /Alex Surveyor/);
  ...
  assert.match(html, /Request a product/);
