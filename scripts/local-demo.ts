...
const context: OpportunityContext = {
  opportunityId: "10000000-0000-4000-8000-000000000002", name: "Brighton Enquiry — Jamie Taylor", streetName: "10 Sample Street, Brighton", propertyPostcode: "BN1 1AA",
  customer: { contactId: "10000000-0000-4000-8000-000000000001", name: "Jamie Taylor", email: "jamie.taylor@example.test", mobile: "07700 900123" },
  region: { id: "50000000-0000-4000-8000-000000000001", name: "Brighton", telephone: "01273 034001", senderMailbox: "brighton@example.test", timeZone: "Europe/London", surveyDurationMinutes: 60, businessDayStartHour: 9, businessDayEndHour: 17, autoScheduleEnabled: true }
};
